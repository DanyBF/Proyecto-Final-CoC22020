...
<%
	...
	Pedido pedido = new Pedido(idPedido, nombre, apellido, usuario, mail, lugarentrega, localidad, codpostal, formadepago, tarjtitular, Integer.valueOf(tarjnumero), tarjvto, Integer.valueOf(tarjclave));
